//LOS COMENTARIOS EN INGLES SON DEL CODIGO ORIGINAL
//LOS COMENTARIOS EN ESPAÑOL SON LAS MODIFICACIONES REALIZADAS PARA NUESTRO PROYECTO

//Include the needed library, we will use softer serial communication with the ESP8266
#include <SoftwareSerial.h>
#include <avr/power.h>

//No utilizaremos las siguientes librerias debido a que no utilizamos pantalla LCD, por lo que hay que quitarlas despues
//LCD config
//#include <Wire.h> 
